 ...
 export const AsanaProvider=({children})=>{// provider : wraps your app and provides shared data. Children refers to all the compnents insdie provider
    ...
    return(//shares selectedAsanas, selectAsana,removeAsana
